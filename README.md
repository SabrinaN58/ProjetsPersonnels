...
**Objectif** : Comprendre le comportement des désabonnés pour améliorer la rétention  

**Compétences** :
- **Power BI** : Nettoyage et préparation (Power Query) - Modélisation des données (Schéma étoile) - Visualisations  

**Résultats** : Identifiaction du profil type des désabonnés et mettre en place des actions correctives pour limiter la hausse du churn

## 📈 Analyse de la performance des produits - NORTHWIND
**Objectif** : Analyser les produits sous-performants en volume et chiffre d'affaires 
...
**Compétences** :
- **Python** : Nettoyage et préparation des données - Analyse exploratoire - Visualisations (Matplotlib, Seaborn)   
